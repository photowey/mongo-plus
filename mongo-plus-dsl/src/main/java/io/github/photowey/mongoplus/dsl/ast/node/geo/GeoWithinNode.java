...
/**
 * GeoWithinNode - AST node for $geoWithin operator.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/12
...
@NoArgsConstructor
@AllArgsConstructor
public class GeoWithinNode implements AstNode {

    private static final long serialVersionUID = -7434531233813253959L;
