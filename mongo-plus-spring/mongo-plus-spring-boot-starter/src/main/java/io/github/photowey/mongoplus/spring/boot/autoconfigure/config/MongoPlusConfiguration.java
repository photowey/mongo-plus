...
/**
 * MongoPlusConfiguration - Traditional configuration for Spring Boot 2.7 and earlier.
 * Uses @Configuration instead of @AutoConfiguration.
 *
 * <p>
 * This configuration is activated when @AutoConfiguration is not available (Spring Boot &lt; 2.7).
...
public class MongoPlusConfiguration extends AbstractMongoPlusConfiguration { }
