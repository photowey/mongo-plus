...
/**
 * DeleteMethod - Built-in delete(wrapper), registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class DeleteMethod extends AbstractMethod {
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            ...
            return getter.queryExecutor().delete(wrapper, (Class<Object>) entityClass);
        };
    }
}
