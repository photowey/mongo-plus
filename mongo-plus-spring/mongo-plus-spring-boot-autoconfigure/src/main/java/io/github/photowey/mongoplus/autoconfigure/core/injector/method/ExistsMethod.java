...
/**
 * ExistsMethod - Built-in exists, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class ExistsMethod extends AbstractMethod {

    public static final String METHOD_NAME = "exists";
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            AbstractWrapper<Object> wrapper = (AbstractWrapper<Object>) args[0];
            return getter.queryExecutor().exists(wrapper, (Class<Object>) entityClass);
        };
    }
}
