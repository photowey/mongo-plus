...
/**
 * DeleteBatchMethod - Built-in deleteBatch, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class DeleteBatchMethod extends AbstractMethod {

    public static final String METHOD_NAME = "deleteBatch";
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            List<Serializable> ids = (List<Serializable>) args[0];
            return getter.queryExecutor().deleteBatch(ids, (Class<Object>) entityClass);
        };
    }
}
