...
/**
 * UpdateMethod - Built-in update(wrapper), registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class UpdateMethod extends AbstractMethod {
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            UpdateWrapper<Object> updateWrapper = (UpdateWrapper<Object>) args[0];
            return getter.queryExecutor().update(updateWrapper, (Class<Object>) entityClass);
        };
    }
}
