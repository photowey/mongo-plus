...
/**
 * SelectByIdMethod - Built-in selectById, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class SelectByIdMethod extends AbstractMethod {

    public static final String METHOD_NAME = "selectById";
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) ->
            getter.queryExecutor().selectById((Serializable) args[0], (Class<Object>) entityClass);
    }
}
