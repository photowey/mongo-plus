...
/**
 * InsertBatchMethod - Built-in insertBatch, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class InsertBatchMethod extends AbstractMethod {
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            ...
            return getter.queryExecutor().insertBatch(entities, (Class<Object>) entityClass);
        };
    }
}
