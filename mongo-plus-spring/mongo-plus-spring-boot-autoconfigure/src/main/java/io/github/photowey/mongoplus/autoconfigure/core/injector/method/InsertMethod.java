...
/**
 * InsertMethod - Built-in insert, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
 */
public final class InsertMethod extends AbstractMethod {
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            getter.queryExecutor().insert(args[0], getCollectionName(entityClass));
            return true;
        };
    }
