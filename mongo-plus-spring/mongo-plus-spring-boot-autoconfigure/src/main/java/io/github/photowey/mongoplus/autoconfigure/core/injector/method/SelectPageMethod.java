...
/**
 * SelectPageMethod - Built-in selectPage, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class SelectPageMethod extends AbstractMethod {

    public static final String METHOD_NAME = "selectPage";
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) -> {
            Page<Object> page = (Page<Object>) args[0];
            AbstractWrapper<Object> wrapper = (AbstractWrapper<Object>) args[1];
            return getter.queryExecutor().selectPage(page, wrapper, (Class<Object>) entityClass);
        };
    }
}
