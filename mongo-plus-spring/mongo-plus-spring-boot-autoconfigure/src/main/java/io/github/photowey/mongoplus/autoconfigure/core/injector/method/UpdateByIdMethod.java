...
/**
 * UpdateByIdMethod - Built-in updateById, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
 */
public final class UpdateByIdMethod extends AbstractMethod {
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) ->
            getter.queryExecutor().updateById(args[0], getCollectionName(entityClass));
    }
