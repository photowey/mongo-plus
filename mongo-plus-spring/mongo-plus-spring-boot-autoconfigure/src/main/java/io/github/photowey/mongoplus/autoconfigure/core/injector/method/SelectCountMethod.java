...
/**
 * SelectCountMethod - Built-in selectCount, registered as MapperMethod.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
...
public final class SelectCountMethod extends AbstractMethod {

    public static final String METHOD_NAME = "selectCount";
    ...
    protected MethodHandler createHandler() {
        return (getter, entityClass, args) ->
            getter.queryExecutor().selectCount(
                (AbstractWrapper<Object>) args[0],
                EntityResolver.resolve(entityClass).getCollectionName()
            );
    }
}
