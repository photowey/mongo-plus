 ...
 */
package io.github.photowey.mongoplus.examples.spring.boot.b2x.plugin;
...
import io.github.photowey.mongoplus.examples.spring.boot.b2x.service.UserService;
...
class PluginTracingInterceptorExampleTest extends AbstractMongoTest {
    ...
    @Test
    @DisplayName("Given tracing interceptor example, when saving and counting users, then mapper and query events are recorded")
