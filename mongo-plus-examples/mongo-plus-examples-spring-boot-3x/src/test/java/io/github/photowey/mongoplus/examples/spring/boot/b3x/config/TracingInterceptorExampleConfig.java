 ...
 */
package io.github.photowey.mongoplus.examples.spring.boot.b3x.config;
...
/**
 * TracingInterceptorExampleConfig - Example configuration that registers a tracing interceptor
 * for tests and sample usage.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/11
 */
@Configuration
public class TracingInterceptorExampleConfig {
