...
import io.github.photowey.mongoplus.examples.spring.boot.b3x.core.domain.document.GeneratedUserDocument;
import io.github.photowey.mongoplus.examples.spring.boot.b3x.core.domain.document.GeneratedUserDocumentAutoMapper;
...
/**
 * GeneratedAutoMapperTest - Verifies generated auto mapper integration for Boot 3.x.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/10
...
class GeneratedAutoMapperTest extends AbstractMongoTest {
    ...
    void givenGeneratedAutoMapper_whenInsertAndSelectById_thenGeneratedBeanWorks() {
        ...
        assertNotNull(found);
        assertEquals("generated-boot3", found.getName());
