...
/**
 * DefaultExecutorGetter - Provides fixed QueryExecutor and AggregationExecutor accessors.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/09
 */
public class DefaultExecutorGetter implements ExecutorGetter {

    private final QueryExecutor queryExecutor;
    private final AggregationExecutor aggregationExecutor;

    public DefaultExecutorGetter(QueryExecutor queryExecutor, AggregationExecutor aggregationExecutor) {
    ...
    public AggregationExecutor aggregationExecutor() {
        return this.aggregationExecutor;
    }
}
