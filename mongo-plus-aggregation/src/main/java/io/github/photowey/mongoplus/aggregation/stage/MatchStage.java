...
/**
 * MatchStage - Models a MongoDB {@code $match} stage.
 *
 * @author photowey
 * @version 2026.1.0.0
 * @since 2026/03/12
...
public class MatchStage implements Stage {
    ...
    /**
     * Creates a stage backed by a pre-built criteria document.
     *
     * @param criteria the match criteria to wrap
     */
    public MatchStage(Document criteria) {
    ...
    public Document toBson() {
        return new Document(MongoPlusConstants.MATCH, this.criteria);
    }
}
